...
export default function StaticRoutingPage() {
    ...
    const clicker = (event: any) => {
        ...
        alert(`${event.currentTarget.id}님이 작성한 글입니다`) //event.currentTarget => 현재 선택한 타겟
    }                                           
    ...
    return (
         <div>
            ...
            <div onClick={clicker} id={el.writer} >
                <span><input type="checkbox"/></span>
                <span style={qqq}>{el.number}</span>
                <span onClick={clicker} id={el.writer} style={{margin: "10px"}}>{el.title}</span>
